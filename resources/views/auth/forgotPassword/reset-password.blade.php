                ...
                <div class="col-lg-5 col col-md-auto bg-white shadow-sm p-4 text-muted ">
                    ...
                    <div class="text-warning rounded-1 py-2 border-0" role="alert">
                        ...
                        <ul class="text-muted mt-2">
                            ...
                            <li class="list-unstyled ">
                                <p class="fz-14 mb-1">Mật khẩu không nên có tên, ngày sinh và những thông tin hiển thị
                                </p>
                            </li>
                        </ul>
                    </div>
                    <form action="{{ route('password.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <input type="password" name="password" class="form-control input-group-password" id="password-new" placeholder="Mật khẩu hiện tại" aria-label="Username" aria-describedby="addon-wrapping">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <input type="password" name="password_confirmation" class="form-control input-group-password" id="password-confirm" placeholder="Xác nhận mật khẩu" aria-label="Username" aria-describedby="addon-wrapping">
                                <span class="input-group-text icon-eye-password" id="addon-wrapping">
                                    <i class="fa-solid fa-eye"></i>
                                    <i class="fa-solid fa-eye-slash d-none"></i>
                                </span>
