    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        <thead class="table-light">
            <tr>
                ...
                <th class="sort" data-sort="name">Thuộc tính</th>
                <th class="sort text-center" data-sort="status" style="width: 100px">Trạng thái</th>
                ...
                <tr>
                    ...
                    <td class="customer_single_td" style="">
                        ...
                        <div style="line-height: 2.2rem">
                            ...
                            @if ($item->attributeCatalogues)
                                <div>
                                    <span>Nhóm thuộc tính:
                                        <strong><a href="{{ route('attribute.catalogue.index') }}"
                                                class="text-danger pe-2">{{ $item->attributeCatalogues->name }}</a></strong>
                                        {{-- @foreach ($item->attributeCatalogues as $catalogue)
                                        @endforeach --}}
                                    </span>
                                </div>
                            @endif
                        ...
                        <div class="dropdown text-end">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink5" style="">
                                ...
                                <li><a class="dropdown-item text-info"
                                        href="{{ route('attribute.update', ['slug' => $item->slug]) }}"> <i
                                            class="ri-edit-box-line"></i>
                                        Chỉnh sửa</a></li>

                                <li><a class="dropdown-item text-danger"
                                        href="{{ route('attribute.delete', ['id' => $item->id]) }}"><i
...
<div class="container-fluid">
    {{ $attributes->onEachSide(5)->links('pagination::bootstrap-5') }}
</div>