<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('attribute.edit', ['slug' => $attribute->slug]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        value="{{ old('name',$attribute->name) }}" placeholder="Tên thuộc tính">
                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="slug" class="form-control"
                                                        id="" value="{{ old('slug', $attribute->slug) }}"
                                ...
                                <div>
                                    <label>Mô tả</label>
                                    <div>
                                        <textarea class="form-control ck-editor" id="description" data-height="150" name="description">{{ old('description', $attribute->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="attribute_catalogue_id">
                                        ...
                                        @foreach ($attributeCatalogues as $key => $val)
                                            <option value="{{ $val->id }}" {{ ($attribute->attribute_catalogue_id == $val->id) ? 'selected' : '' }}>{{ $val->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="publish">
                                        ...
                                        <option value="1" {{ $attribute->publish == 1 ? 'selected' : '' }}>Hiển thị
                                        </option>
                                        <option value="0" {{ $attribute->publish == 0 ? 'selected' : '' }}>Ẩn</option>
                                    </select>
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="image-target">
                                                <img src="{{ old('image', $attribute->image ?? '') ? ''. old('image', $attribute->image ?? '') : '/libaries/upload/images/img-notfound.png' }}"
                                                    alt=""
                                                    class="render-image  object-fit-cover rounded-1 mb-2 position-relative "
                                                    width="96" height="96">
                                            </span>
                                            {{-- input ẩn gửi lên controller xử lý  --}}
                                            <input type="hidden" name="image" value="{{ $attribute->image }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
