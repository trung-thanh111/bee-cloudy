    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        <thead class="table-light">
            <tr>
                ...
                <th class="sort">Nhóm thuộc tính</th>
                <th class="sort text-center" style="width: 100px">Trạng thái</th>
                            ...
                            <div class="dropdown text-end">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink5" style="">
                                    ...
                                    <li><a class="dropdown-item text-info"
                                            href="{{ route('attribute.catalogue.update', ['slug' => $item->slug]) }}">
                                            <i class="ri-edit-box-line"></i>
                                            Chỉnh sửa</a></li>

                                    <li><a class="dropdown-item text-danger"
                                            href="{{ route('attribute.catalogue.delete', ['id' => $item->id]) }}"><i
...
<div class="container-fluid">
    @if ($attributeCatalogues != null)
        {{ $attributeCatalogues->onEachSide(3)->links('pagination::bootstrap-5') }}
    @endif
</div>
