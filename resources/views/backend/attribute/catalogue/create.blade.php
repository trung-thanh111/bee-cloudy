<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="mb-sm-0">Thêm mới loại thuộc tính</h4>
            ...
            <form action="{{ route('attribute.catalogue.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        value="{{ old('name') }}" placeholder="Tên nhóm thuộc tính">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="parent_id">
                                        ...
                                        @foreach ($attributeCatalogues as $key => $attributeCatalogue)
                                            <option value="{{ $attributeCatalogue->id }}">{{ $attributeCatalogue->name }}
                                            </option>
                                        @endforeach
                                    </select>
