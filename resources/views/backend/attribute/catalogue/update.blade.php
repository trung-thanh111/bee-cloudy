<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('attribute.catalogue.index') }}">Danh
                                        sách</a>
                                </li>
            ...
            <form action="{{ route('attribute.catalogue.edit', ['slug' => $attributeCatalogue->slug]) }}" method="POST"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="slug" class="form-control"
                                                        id=""
                                                        value="{{ old('slug', $attributeCatalogue->slug) }}"
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="publish">
                                        ...
                                        <option value="1" {{ $attributeCatalogue->publish == 1 ? 'selected' : '' }}>Hiển thị
                                        </option>
                                        <option value="0" {{ $attributeCatalogue->publish == 0 ? 'selected' : '' }}>Ẩn</option>
                                    </select>
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="image-target">
                                                <img src="{{ old('image', $attributeCatalogue->image ?? '') ? ''. old('image', $attributeCatalogue->image ?? '') : '/libaries/upload/images/image-notfound.png' }}"
                                                    alt=""
                                                    class="render-image  object-fit-contain rounded-1 mb-2 position-relative "
                                                    width="96" height="96">
                                            </span>
                                            {{-- input ẩn gửi lên controller xử lý  --}}
                                            <input type="hidden" name="image" value="{{ $attributeCatalogue->image }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
