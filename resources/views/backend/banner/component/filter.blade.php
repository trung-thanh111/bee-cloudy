<div class="col">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="col-sm-auto">
            <div>
                <a href="{{ route('banner.create') }}" class="btn btn-success add-btn"><i
...
<form id="searchForm" action="{{ route('banner.index') }}" method="GET">
                    ...
                    <form>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="keyword" value="{{ request('keyword') ?: old('keyword') }}"
                                ...
                                placeholder="Tìm kiếm tên v.v.." aria-describedby="button-addon1">
                        </div>
                    </form>
                </div>
            </div>
