                            ...
                            <div class="align-items-center">
                                ...
                                <div class="pt-3 pb-3">
                                    <span style="line-height: 1.4rem">Thông tin bạn đang muốn xóa là<span
                                            class="text-danger fw-bold fz-14"> {{ $banner->name }}.</span> Không thể khôi phục!</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card" style="height: 125px">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label" style="padding-bottom: 2px">Tên banner:</label>
                                            <input type="text" class="form-control" name="name" id=""
                                                value="{{ e($banner->name) }}" disabled>
                                            @if ($errors->has('name'))
