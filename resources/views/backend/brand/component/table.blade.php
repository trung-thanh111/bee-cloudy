    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        <thead class="table-light">
            <tr>
                ...
                <th class="sort">Thương hiệu</th>
                <th class="sort text-center" style="width: 130px">Thành lập</th>
                <th class="sort text-center" style="width: 130px">Trạng thái</th>
                    ...
                    <tr>
                        ...
                        <td class="customer_single_td" style="">
                            <img src="{{ $item->image ? $item->image : '/libaries/upload/images/img-notfound.png' }}"
                                alt="" class="object-fit-contain me-2 text-start bg-light rounded-2"
                            ...
                            <div style="line-height: 2.2rem">
                                ...
                                <div>
                                    <span>Trụ sở chính:
                                        <strong><span class="text-success">{{ $item->made_in }}</span></strong>
                                    </span>
                                </div>
                            </div>
                        </td>
                        <td class="text-center">
                            <span class="fz-14 ">
                                {{ date('d-m-Y', strtotime($item->establish)) }}
                            </span>
                        </td>
                            ...
                            <div class="dropdown text-end">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink5" style="">
                                    ...
                                    <li><a class="dropdown-item text-info"
                                            href="{{ route('brand.update', ['slug' => $item->slug]) }}">
                                            <i class="ri-edit-box-line"></i>
                                            Chỉnh sửa</a></li>

                                    <li><a class="dropdown-item text-danger"
                                            href="{{ route('brand.delete', ['id' => $item->id]) }}"><i
