<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="mb-sm-0">Chỉnh sửa thương hiệu</h4>
            ...
            <form action="{{ route('brand.edit', ['slug' => $brand->slug]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        value="{{ old('name', $brand->name) }}" placeholder="Tên thương hiệu thuộc tính">
                                    @if ($errors->has('name'))
                                ...
                                <div>
                                    <label>Mô tả</label>
                                    <div>
                                        <textarea class="form-control ck-editor" id="ck-editor" data-height="200" name="description">{{ old('description', $brand->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="made_in" name="made_in" placeholder="Địa điểm ,quốc gia, sản xuất " value="{{ old('made_in', $brand->slug) }}">
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="dateofyear" class="form-label">Thành lập</label>
                                    <input type="date" class="form-control" id="dateofyear" name="establish" value="{{ old('establish', $brand->establish) }}">
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="publish">
                                        ...
                                        <option value="1" {{ $brand->publish == 1 ? 'selected' : '' }}>Hiển thị
                                        </option>
                                        <option value="0" {{ $brand->publish == 0 ? 'selected' : '' }}>Ẩn</option>
                                    </select>
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="image-target">
                                                <img src="{{ old('image', $brand->image ?? '') ? ''. old('image', $brand->image ?? '') : '/libaries/upload/images/img-notfound.png' }}"
                                                    alt=""
