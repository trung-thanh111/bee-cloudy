                                                    ...
                                                    <tbody>
                                                        <template v-for="(v , k) in list">
                                                            <tr class='align-middle text-center'>
                                                                ...
                                                                <td class='text-start' style="max-width: 150px">@{{ v.ten_kh }}</td>
                                                                <td class='text-start text-truncate' style="max-width: 200px">@{{ v.name }}</td>
                                                                        ...
                                                                        <span class="product-rate">
                                                                          <i v-for="index in 5" 
                                                                             ...
                                                                             :class="[
                                                                               'fas',
                                                                               {
                                                                                 'fa-star': index <= Math.floor(v.publish),
                                                                                 'fa-star-half-alt': index === Math.ceil(v.publish) && v.publish % 1 !== 0,
                                                                                 'far fa-star': index > Math.ceil(v.publish)
                                                                               }
                                                                             ]"
                                                                             style="color: #FFD700;"
                                                                          ></i>
                                                                ...
                                                                <td class='text-center'>@{{ v.like_count }}</td>
