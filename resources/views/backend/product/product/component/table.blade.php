    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        <thead class="table-light">
            <tr>
                ...
                <th class="sort text-center" style="width: 160px">Giá gốc</th>
            ...
            @foreach($products as $key => $item)
                ...
                <tr>
                    ...
                    <td class="customer_single_td" style="">
                        <img src="{{ ($item->image) ? $item->image : '/libaries/upload/images/img-notfound.png' }}" alt=""
                            class="object-fit-contain me-2 text-start" width="120px" height="80px">
