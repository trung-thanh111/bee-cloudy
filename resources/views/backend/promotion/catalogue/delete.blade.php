                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="align-items-center">
                                ...
                                <span style="line-height: 1.4rem">Sau khi xóa thì bạn sẽ không thể phục hồi lại như ban đầu. Hãy cân nhắc kỹ trước khi xóa!<p class="fst-italic">Nếu bạn đã chắc chắn muốn xóa, hãy thực hiện thao tác ngay dưới đây.</p></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="height: 125px">
                        <div class="card-body">
                            <div class="align-items-center">
                                <h5>Thông tin</h5>
                                <div class="pt-3 pb-3">
                                    <span style="line-height: 1.4rem">Thông tin bạn đang muốn xóa là<span class="text-danger fw-bold fz-14"> {{ $promotion->name }}.</span> Không thể khôi phục!</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card" style="height: 125px">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label" style="padding-bottom: 2px">Tên voucher:</label>
                                            <input type="text" class="form-control" name="name" id="" value="{{ e($promotion->name) }}" disabled>
                                            @if ($errors->has('name'))
