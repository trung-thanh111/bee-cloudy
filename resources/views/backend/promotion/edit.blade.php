                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="usage_limit" value="{{ old('usage_limit', $promotion->usage_limit) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control ck-editor" name="description" id="ck-editor" data-height="250">{{ old('description', $promotion->description) }}</textarea>
                                </div>
                                <!-- Áp dụng cho -->
                                <div class="mb-3">
                                    <h5 class="mb-0">Áp dụng cụ thể</h5>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="apply-for" name="apply_for" class="form-select" required>
                                        <option value="all" {{ old('apply_for', $promotion->apply_for) == 'all' ? 'selected' : '' }}>Áp dụng cho tất cả sản phẩm</option>
                                        <option value="specific_products" {{ old('apply_for', $promotion->apply_for) == 'specific_products' ? 'selected' : '' }}>Áp dụng cho sản phẩm cụ thể</option>
                                        <option value="freeship" {{ old('apply_for', $promotion->apply_for) == 'freeship' ? 'selected' : '' }}>Miễn phí vận chuyển</option>
                                    </select>
                                    ...
                                    <div id="specific-products-section" class="mb-3" style="display: none;">
                                        ...
                                        <select id="product-dropdown" class="form-select" name="product_id">
                                            ...
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" {{ (old('product_id', $promotion->products->first()->id ?? '') == $product->id) ? 'selected' : '' }}>
                                                    {{ $product->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="text-end mb-3">
                            <button type="submit" class="btn btn-success w-sm">Cập Nhật Khuyến Mãi</button>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="row g-1">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="minimum_amount" class="form-control" value="{{ old('minimum_amount', $promotion->minimum_amount) }}" placeholder="100.000 VND">
                                            <span class="input-group-text">VND</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="g-3">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="datetime-local" class="form-control" name="start_date" value="{{ old('start_date', $promotion->start_date ) }}" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="datetime-local" class="form-control" name="end_date" value="{{ old('end_date', $promotion->end_date) }}" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <input type="hidden" name="image" value="{{ old('image', $promotion->image) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
