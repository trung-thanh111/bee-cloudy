                        ...
                        <div class="text-muted d-flex justify-content-between align-items ">
                            <div class="row ps-lg-3 pe-lg-3 p-lg-5 p-md-5 p-sm-4 p-xs-3">
                                <div class="col-lg-4 col-md-4">
                                    <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('templates/bee-cloudy-user/libaries/images/avatar_user/default-avatar.jpg') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center flex-grow">
                                                ...
                                                <a href="{{ route('profile.edit') }}"><i
                                                        class="fa-solid fa-pen fz-18 text-muted pe-3"
                                            ...
                                            <div class="table-reposive mt-5">
                                                <table class="table table-borderless align-middle ps-lg-3">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <td>Ngày sinh :</td>
                                                            <th>{{ $user->birthday ? \Carbon\Carbon::parse($user->birthday)->format('d/m/Y') : 'Chưa cập nhật' }}
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                </table>
